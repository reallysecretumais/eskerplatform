...
3. **Phase 3 — Host portal**: self-listing (admin-approved) + owner↔guest chat with Esker oversight + WhatsApp notify. ⚠️ Needs the payout/commission decision first. (`conversations.owner_account_id` already reserved for it.)
