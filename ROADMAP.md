...
3. **Phase 3 — Host portal** ✅ BUILT (2026-07-08, migration `14_host_portal.sql`): owners self-list **free** (commission seam `HOST_COMMISSION_PCT=0`), Esker approves in the CRM, guests book via the **unchanged advance flow**, host handles guest chat (owner-comms routing; staff bell quiet; throttled host email). Host dashboard/listings/new/edit/messages + CRM review queue. Verified 15/15. Open: host calendar, payouts ledger, host WhatsApp.
